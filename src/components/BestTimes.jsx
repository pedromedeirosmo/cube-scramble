export default function BestTimes({ times, bestTime, openConfirm }) {
  ...
  return (
    <div className="text-center mb-4">
      ...
      <button
        onClick={openConfirm}
        className="mt-2 px-4 py-2 rounded-lg bg-red-400/10 text-red-400 text-xs font-bold uppercase tracking-wider hover:bg-red-400/20 transition-all active:scale-95 hover:cursor-pointer hover:scale-105 border border-red-400/20"
      >
        Limpar Tempos
      </button>
    </div>
